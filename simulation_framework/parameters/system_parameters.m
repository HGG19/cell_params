...
SysPara.s = 144;  % Number of serial cells
...
SysPara.Balancing.t_Start = inf;                          % Specify simulation time after witch balancing is allowed. Set to 'inf' to disable balancing
